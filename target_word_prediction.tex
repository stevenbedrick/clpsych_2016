...
% FIXME(Joel, Steve): what the heck does @ mean here? Replace with IPA or something. Is it schwa?
\end{figure}
...
We first convert our best-guess orthographic representation of the subject's non-lexical production to an estimated phonological representation using the Phonetisaurus grapheme-to-phoneme library \cite{Novak:2011aa}. Next, for each erroneous production, we compute the phonologically-aware edit distance, and also apply the AphasiaBank phonological similarity rules. 
